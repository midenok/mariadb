...
enum dict_fld_sys_vtd_enum {
	...
	DICT_FLD__SYS_VTD__TRX_ID_END			= 3,
	DICT_FLD__SYS_VTD__OLD_NAME			= 4,
	DICT_FLD__SYS_VTD__NAME				= 5,
	DICT_FLD__SYS_VTD__FRM_IMAGE			= 6,
	DICT_FLD__SYS_VTD__COL_RENAMES			= 7,
        DICT_NUM_FIELDS__SYS_VTD			= 8
};
