              ...
              for (uint idx= 0; idx < tab->table->s->keys; idx++)
              {
                ...
                */
                ...
                const int read_direction=
                  test_if_order_by_key(join, join->order, tab->table, idx, &not_used);
                if (read_direction == 0)
                {
			...
			bool no_changes, const key_map *map)
{
  ...
  */
  ...
  else if (tab->type == JT_NEXT && !table->opt_range_keys.is_set(tab->index))
  {
                         ...
                         uint *saved_best_key_parts)
{
  ...
  */
  if (ref_key >= 0 && ref_key != MAX_KEY && cur_access_method == JT_REF)
  {
    /*
                                         ...
                                         &used_key_parts)))
    {
      ...
      */ 
          ...
          if (used_pk_parts)
	  {
        ...
        */
        if (((cur_access_method == JT_ALL || cur_access_method == JT_NEXT)
